            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4 price">
                        ...
                        <input type="number" name="price" step="0.01" id="price" class="form-control" min="0" placeholder="5000000" >
                    </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4 lot_area">
                        ...
                        <input type="number" name="lot_area" step="0.01" class="form-control" id="lot_area" min="0" placeholder="150">
                    </div>

                    <div class="col-md-4 floor_area">
                        <label class="form-label fw-semibold">Floor Area (sqm)</label>
                        <input type="number" name="floor_area" step="0.01" id="floor_area" class="form-control" min="0" placeholder="100">
                    </div>
                </div>
            </div>
        </div>
