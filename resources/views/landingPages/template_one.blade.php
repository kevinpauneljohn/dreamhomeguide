    ...
    <section class="hero text-center">
        <div class="container">
            <h1 class="mb-3">
                ...
                <strong>Alpine Residences</strong>
            </h1>
            <p class="mb-3">
                Get updated prices, available units, sample computations, and exclusive promos.
                A licensed property consultant will assist you for free.
            </p>
        </div>
    </section>
            ...
            <div class="col-lg-6 col-md-8">
                ...
                <div class="card form-card border-0 p-4 p-md-5">
                    <h5 class="fw-semibold text-center mb-2">
                        Alpine Residences Inquiry Form
                    </h5>
                    ...
                    <form id="alpineInquiryForm" method="POST" action="{{route('form-submit')}}">
                        ...
                        <!-- Hidden Project Tag -->
                        <input type="hidden" name="project" value="Alpine Residences">

                        <div class="d-grid mt-4">
                            <button type="submit" class="btn btn-primary btn-lg">
                                📩 Get Alpine Residences Details
                            </button>
                        </div>
